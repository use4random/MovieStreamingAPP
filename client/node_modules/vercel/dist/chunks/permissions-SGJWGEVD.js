...
async function permissions(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-EOMIQLRH.js")).default(client, argv, telemetry);
    case "add":
      return (await import("./add-PP3PJPJV.js")).default(client, argv, telemetry);
    case "rm":
      return (await import("./rm-BZNKJRXU.js")).default(client, argv, telemetry);
    case "clear":
      return (await import("./clear-Z4IKUIN7.js")).default(client, argv, telemetry);
    default:
