...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-2TKUIUK4.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-CHFKZKKP.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-OUI4ZB5R.js")).default(client, args, telemetry);
    default:
