            ...
            <div className="player-section" id="playerSection">
                <div className="player-hud-topbar">
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        ...
                        {currentNodeHealth && (
                            <span style={{ fontSize: '10px', background: currentNodeHealth.healthy ? 'rgba(0,255,136,0.1)' : 'rgba(255,81,104,0.1)', padding: '2px 8px', borderRadius: '4px', color: currentNodeHealth.healthy ? 'var(--green)' : 'var(--brand)' }}>
